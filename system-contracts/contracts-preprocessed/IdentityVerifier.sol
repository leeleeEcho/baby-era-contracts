...
contract IdentityVerifier is IIdentityVerifier, SystemContractBase {
    ...
    /// @notice Register a Groth16 verifier for a circuit type. Only system call.
    function setCircuitVerifier(uint8 circuitType, address verifier) external override onlySystemCall {
